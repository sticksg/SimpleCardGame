...
# Card Table:
    # TYPES
        ...
        # 8: Spade
    # VALUES
        # Card types 5-8 (inclusive) are assigned a value 1-10 (inclusive) representing the number on the card.
...
def determineWinner():
    ...
    for i, plr in enumerate(ActivePlayers, 1):
        ...
        #print(f"{plr.name}'s Score: {score} 💵") not needed as its listed after
